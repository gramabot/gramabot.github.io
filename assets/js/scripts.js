...
(function($) {
    ...
    $(".list-currency li").on("click", function() {
        $(".list-currency li").attr('class', '')
        $(this).attr('class', 'active')
        $(".card-body .card-subtitle").text($(this).text())
        if (this.id === "1") {
            $("#oldVal1").text("Rp 99.000")
            $("#newVal1").text("59.000")
            $("#oldVal2").text("Rp 269.000")
            $("#newVal2").text("139.000")
            $("#oldVal3").text("Rp 499.000")
            $("#newVal3").text("239.000")
        } else if (this.id === "3") {
            $("#oldVal1").text("Rp 119.000")
            $("#newVal1").text("69.000")
            $("#oldVal2").text("Rp 329.000")
            $("#newVal2").text("169.000")
            $("#oldVal3").text("Rp 619.000")
            $("#newVal3").text("299.000")
        } else if (this.id === "5") {
            $("#oldVal1").text("Rp 139.000")
            $("#newVal1").text("79.000")
            $("#oldVal2").text("Rp 389.000")
            $("#newVal2").text("199.000")
            $("#oldVal3").text("Rp 739.000")
            $("#newVal3").text("359.000")
        }
    });
